...
TEST_CASE ("2: Testing sane::DBHandler: Add YouTube channels to DB") {
    ...
    for (int i = 0; i <= channelAmount; ++i) {
        ...
        REQUIRE(channelEntity->getTitleAsString()              == DB_YT_CHANS_TEST_002_STR_PREFIX_TITLE + std::to_string(i) );
        ...
        REQUIRE(channelEntity->getDescriptionAsString()        == DB_YT_CHANS_TEST_002_STR_PREFIX_DESC  + std::to_string(i) );
