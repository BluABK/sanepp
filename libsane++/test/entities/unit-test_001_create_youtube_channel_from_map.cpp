...
TEST_CASE ("1: Testing sane::entities: Create and instantiate a YoutubeChannel entity from map.") {
    ...
    REQUIRE(channelEntity->getTitleAsString()              == ENTITY_TEST_001_STRING_PREFIX_TITLE             );
    ...
    REQUIRE(channelEntity->getDescriptionAsString()        == ENTITY_TEST_001_STRING_PREFIX_DESCRIPTION       );
